...
const Meta: FC<{
	...
	const metaDesc: string =
		COMPANY_FULL_NAME +
		' - Фонд не має на меті отримання прибутку. Разом з тим ми існуємо' +
		' завдяки благодійних внесків. Кожна гривня, що перераховується нам на' +
		' рахунок витрачається за виключним цільовим призначенням «Допомога постраждалим внаслідок військової агресії російських окупантів». За кожну витрачену суму ми надаємо відповідні звіти! Ми впевнені, що разом ми зможемо відновити нашу країну!';
